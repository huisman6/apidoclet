...
public class RequestMappingEndpointMappingProvider implements EndpointMappingProvider {
  ...
  public EndpointMapping produce(AnnotationDesc[] classOrMethodAnnotationDescs,
    ...
    AnnotationDesc requestMapping =
        AnnotationUtils.searchFirst(classOrMethodAnnotationDescs, RequestMapping.class.getName());
    ...
    AnnotationValue valObj = attributes.get("value");
    // 数组值是以annotationValue封装的，我们会将数组转换为List<
    @SuppressWarnings("unchecked")
    List<String> urls = (List<String>) valObj.getValue();
    String requestPath = "";
    ...
    @SuppressWarnings("unchecked")
    List<String> methods = (List<String>) attributes.get("method").getValue();
  ...
  private void resolveConditionParams(Map<String, AnnotationValue> attributes,
    ...
    List<String> params = (List<String>) attributes.get("params").getValue();
    ...
    List<String> headers = (List<String>) attributes.get("headers").getValue();
    ...
    // consumes,produces
    List<String> consumes = (List<String>) attributes.get("consumes").getValue();
    ...
    List<String> produces = (List<String>) attributes.get("produces").getValue();
